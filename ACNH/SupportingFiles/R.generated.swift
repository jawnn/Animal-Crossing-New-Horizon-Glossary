...
struct R: Rswift.Validatable {
  ...
  struct nib {
    ...
    /// Nib `CritterListViewController`.
    static let critterListViewController = _R.nib._CritterListViewController()
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "CritterListViewController", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.critterListViewController) instead")
    static func critterListViewController(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.critterListViewController)
    }
    #endif
    ...
    static func critterListViewController(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> UIKit.UIView? {
      return R.nib.critterListViewController.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? UIKit.UIView
    }
...
struct _R: Rswift.Validatable {
  ...
  struct nib {
    ...
    struct _CritterListViewController: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "CritterListViewController"
